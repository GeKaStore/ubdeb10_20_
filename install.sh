...
wget https://raw.githubusercontent.com/GeKaStore/ubdeb10_20_/main/domains.sh && chmod +x domains.sh && ./domains.sh
clear
}
...
wget https://raw.githubusercontent.com/GeKaStore/ubdeb10_20_/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
wget https://raw.githubusercontent.com/GeKaStore/ubdeb10_20_/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear

# limit quota & service xray
wget https://raw.githubusercontent.com/GeKaStore/ubdeb10_20_/main/Xbw_LIMIT/install.sh && chmod +x install.sh && ./install.sh
clear

# limit service ip xray
wget https://raw.githubusercontent.com/GeKaStore/ubdeb10_20_/main/AUTOKILL_SERVICE/service.sh && chmod +x service.sh && ./service.sh
clear
...
# install-ws
wget https://raw.githubusercontent.com/GeKaStore/ubdeb10_20_/main/ws/install-ws.sh && chmod +x install-ws.sh && ./install-ws.sh
clear

# banner ssh
wget https://raw.githubusercontent.com/GeKaStore/ubdeb10_20_/main/ws/banner_ssh.sh && chmod +x banner_ssh.sh && ./banner_ssh.sh
clear
}
...
apt install rclone
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://github.com/GeKaStore/ubdeb10_20_/raw/main/rclone.conf"
git clone  https://github.com/GeKaStore/wondershaper.git
cd wondershaper
make install
cd
rm -rf wondershaper
...
INSTALL_OHP() {
wget https://raw.githubusercontent.com/GeKaStore/ubdeb10_20_/main/ws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

INSTALL_FEATURE() {
wget https://raw.githubusercontent.com/GeKaStore/ubdeb10_20_/main/menu/install_menu.sh && chmod +x install_menu.sh && ./install_menu.sh
clear
}

INSTALL_UDP_CUSTOM() {
wget https://raw.githubusercontent.com/GeKaStore/ubdeb10_20_/main/ws/UDP.sh && chmod +x UDP.sh && ./UDP.sh
clear
}
...
wget https://raw.githubusercontent.com/GeKaStore/ubdeb10_20_/main/install_cron.sh && chmod +x install_cron.sh && ./install_cron.sh
clear
}
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/GeKaStore/ubdeb10_20_/main/versi  )
...
rm -f /root/*.sh
rm -f /root/*.txt
IPVPS= subprocess.getoutput("cat /etc/xray/domain")

function SENDER_NOTIFICATION() {
CHATID="6686272246"
KEY="8104475511:AAEE4Mh0Hw94OcAqAXtvez5PWH77_fqrysg"
...
-d "reply_markup={\"inline_keyboard\":[[{\"text\":\" ʙᴜʏ ꜱᴄʀɪᴘᴛ \",\"url\":\"https://t.me/WuzzSTORE\"}]]}"
